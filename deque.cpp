...
class Deque {
  ...
  class iterator {
    ...
    iterator() noexcept;
    iterator(Distance index) noexcept;
    iterator(T** ptr, size_t pos) noexcept;
    ...
    iterator operator--() noexcept;
    iterator operator+=(Distance number) noexcept;
    iterator operator-=(Distance number) noexcept;
...
//------------iterator--------------//
template <typename T>
typename Deque<T>::iterator operator+(const typename Deque<T>::iterator& it, typename Deque<T>::iterator::Distance number) noexcept;
template <typename T>
typename Deque<T>::iterator operator+(typename Deque<T>::iterator::Distance number, const typename Deque<T>::iterator& it) noexcept;
template <typename T>
typename Deque<T>::iterator operator-(const typename Deque<T>::iterator& it, typename Deque<T>::iterator::Distance number) noexcept;
template <typename T>
typename Deque<T>::iterator operator-(typename Deque<T>::iterator::Distance number, const typename Deque<T>::iterator& it) noexcept;
...
template <typename T>
Deque<T>::iterator::iterator(typename Deque<T>::iterator::Distance index) noexcept : iterator(external_array_ + (index / sz_internal_arr_), index % sz_internal_arr_) {}
template <typename T>
Deque<T>::iterator::iterator(T** ptr, size_t pos) noexcept : ptr_(ptr), pos_(pos) {}
template <typename T>
...
template <typename T>
typename Deque<T>::iterator Deque<T>::iterator::operator+=(typename Deque<T>::iterator::Distance number) noexcept {
  iterator tmp(ptr_ + ((number + pos_) / sz_internal_arr_), (number + pos_) % sz_internal_arr_);
  return tmp;
}
template <typename T>
typename Deque<T>::iterator Deque<T>::iterator::operator-=(typename Deque<T>::iterator::Distance number) noexcept {
...
int main() {
  ...
  Deque<int>::iterator it1 = arr.begin();
